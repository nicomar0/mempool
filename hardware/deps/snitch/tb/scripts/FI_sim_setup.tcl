...
add wave -noupdate -group top /snitch_read_only_cache_tb/dut/*
add wave -noupdate /snitch_read_only_cache_tb/dut/i_lookup/gen_sram/i_tag/sram
add wave -noupdate /snitch_read_only_cache_tb/dut/i_lookup/i_data/sram


do ../fault_injection/ROC_inject_fault.tcl
